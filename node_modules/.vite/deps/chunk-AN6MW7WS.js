...
var ICONS = {
  add: async () => (await import("./add-EBSDUWL6.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-SHGGHQYV.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-62RHIU7G.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-FOQ3VVF5.js")).appStoreSvg,
  apple: async () => (await import("./apple-2KYHB5AL.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-PTBYBZZL.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-HRHN3FOW.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-3RREEIAZ.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-PPW6ONC3.js")).arrowTopSvg,
  bank: async () => (await import("./bank-UBXEMU52.js")).bankSvg,
  browser: async () => (await import("./browser-64JVQ72A.js")).browserSvg,
  card: async () => (await import("./card-PVCK4CB6.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-KX7SQTKS.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-KPZLLODP.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-U6556TQ4.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-YDEUZNOH.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-7MAAHI2Z.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-AJ3M2YCF.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-RNHTU5GY.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-75I5E6UL.js")).clockSvg,
  close: async () => (await import("./close-IO4X2DMU.js")).closeSvg,
  compass: async () => (await import("./compass-TH7O53OG.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-54OO5KDT.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-37FCFOGW.js")).copySvg,
  cursor: async () => (await import("./cursor-JP6AHZHM.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-GAAQWAW4.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-2GMC4DKL.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-BFIZCJX6.js")).disconnectSvg,
  discord: async () => (await import("./discord-NTLELIP7.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-IVDSSU77.js")).etherscanSvg,
  extension: async () => (await import("./extension-ENOE7VC5.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-PGBGGQOM.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-5PCAM7AQ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-SRVHYA43.js")).farcasterSvg,
  filters: async () => (await import("./filters-FQAXOZR5.js")).filtersSvg,
  github: async () => (await import("./github-T2RV5FY3.js")).githubSvg,
  google: async () => (await import("./google-3L77FKB5.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-O7EU33B7.js")).helpCircleSvg,
  image: async () => (await import("./image-VGVBXKPO.js")).imageSvg,
  id: async () => (await import("./id-PVQMUJ7K.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-YVQOHHYB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-FI5Z4QM4.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LR7MXPNN.js")).mailSvg,
  mobile: async () => (await import("./mobile-DMF6ZPFK.js")).mobileSvg,
  more: async () => (await import("./more-PO3EUHJI.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-L3B2Y5LL.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-WQAE3CWN.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-JVGX6BUL.js")).offSvg,
  playStore: async () => (await import("./play-store-XEGO4GTJ.js")).playStoreSvg,
  plus: async () => (await import("./plus-DQW2HQPL.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-3MV6RX3O.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-CVWDV23E.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-3PPDVGUN.js")).refreshSvg,
  search: async () => (await import("./search-QDVJFA6G.js")).searchSvg,
  send: async () => (await import("./send-BGA6J3IB.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-4IPKW6HR.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-ZPWJYWC6.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Z7JVOGNZ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-WGKM4GPX.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JSGEUUPD.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-3XOGYI5L.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-DXHQDMHQ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-6SUJMOPN.js")).twitchSvg,
  twitter: async () => (await import("./x-OILTVP2Z.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-TMHNACP5.js")).twitterIconSvg,
  verify: async () => (await import("./verify-7TPBFNOP.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-4ZSGHLDQ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-M7QMS4JR.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-JNYIITJC.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-JNYIITJC.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-JNYIITJC.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-RM43FHVE.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-KGL7BDQ3.js")).warningCircleSvg,
  x: async () => (await import("./x-OILTVP2Z.js")).xSvg,
  info: async () => (await import("./info-HVBFNCMJ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-ABF7ELZB.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-IPXRZSDY.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AN6MW7WS.js.map
