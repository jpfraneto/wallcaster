...
var ICONS = {
  add: async () => (await import("./add-B2HMPC2B.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GYZ6JQ7O.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-V7RYWMZN.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-VWGSBGB5.js")).appStoreSvg,
  apple: async () => (await import("./apple-OC2KSOED.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-PGBLCIUZ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-RNPRKIPA.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-AC6FO6JN.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-S7MDCK7S.js")).arrowTopSvg,
  bank: async () => (await import("./bank-K4LUE5TS.js")).bankSvg,
  browser: async () => (await import("./browser-PEJZUXMW.js")).browserSvg,
  card: async () => (await import("./card-U4DT2TYY.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-J7D5ESBT.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-CF7NJZTR.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-75H3IJXJ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-WNYPO2CG.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-EL5ZMQMJ.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-KLHHLSWM.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-CHR7MQJ6.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-LLZR4UNN.js")).clockSvg,
  close: async () => (await import("./close-NHHOPWTG.js")).closeSvg,
  compass: async () => (await import("./compass-AEIF3CZ2.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-WNCSMYQZ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-Z2VHILBN.js")).copySvg,
  cursor: async () => (await import("./cursor-2WOMGPOY.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-RRW7TCVJ.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-T6ZMWIP2.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-DGWZY3OS.js")).disconnectSvg,
  discord: async () => (await import("./discord-JC3PTKJ7.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-P4UMANTV.js")).etherscanSvg,
  extension: async () => (await import("./extension-GTXAFHW2.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-HQJMRZAP.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-R23DXM6T.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ETELZST6.js")).farcasterSvg,
  filters: async () => (await import("./filters-WU3XKYLN.js")).filtersSvg,
  github: async () => (await import("./github-7APSXHZU.js")).githubSvg,
  google: async () => (await import("./google-M6X66YRO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-WOVZA3IY.js")).helpCircleSvg,
  image: async () => (await import("./image-OBYZCYOI.js")).imageSvg,
  id: async () => (await import("./id-AAYTKLB3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-5UWZQL5J.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-MACOJZID.js")).lightbulbSvg,
  mail: async () => (await import("./mail-VXT2HJQE.js")).mailSvg,
  mobile: async () => (await import("./mobile-K6UZGIPX.js")).mobileSvg,
  more: async () => (await import("./more-W2F3IKF4.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-AHW3EM76.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-TETAOOJH.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-BLP3ZOGN.js")).offSvg,
  playStore: async () => (await import("./play-store-HJLWQGHS.js")).playStoreSvg,
  plus: async () => (await import("./plus-AITGK527.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-OZWDLZ57.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-7JVGFMNW.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-H3KGP3O7.js")).refreshSvg,
  search: async () => (await import("./search-NPQBEUWS.js")).searchSvg,
  send: async () => (await import("./send-VFY7BIWX.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-UXENDPCP.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-VLNS3BTF.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-RGET63IZ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-Q2LMVBH5.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-X4GZCRAV.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-RW2K5NWJ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-JRNIW636.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-LXTUWHZB.js")).twitchSvg,
  twitter: async () => (await import("./x-G4MHEC6C.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-QHF6ERCX.js")).twitterIconSvg,
  verify: async () => (await import("./verify-VCCX4OXZ.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-2S23OZWM.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-C6SW36OD.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-QNVFFOET.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-QNVFFOET.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-QNVFFOET.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-XVXP54RL.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-XOF3G5VB.js")).warningCircleSvg,
  x: async () => (await import("./x-G4MHEC6C.js")).xSvg,
  info: async () => (await import("./info-FRF4MXNZ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-TTZHN2VN.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-CMBI6FNG.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Y2HMBUVE.js.map
