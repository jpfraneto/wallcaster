...
var useUpload = () => {
  ...
  const [uploadResponse, setUploadResponse] = (0, import_react.useState)(
    null
  );
  const uploadUrlRef = (0, import_react.useRef)(null);
  const pausedRef = (0, import_react.useRef)(false);
  const cancelledRef = (0, import_react.useRef)(false);
  const uploadOffsetRef = (0, import_react.useRef)(0);
  const fileRef = (0, import_react.useRef)(null);
  const headersRef = (0, import_react.useRef)({});
  const lastResponseHeadersRef = (0, import_react.useRef)(null);
  const chunkSizeRef = (0, import_react.useRef)(BASE_CHUNK_SIZE * DEFAULT_CHUNKS);
  ...
  const continueChunkedUpload = (0, import_react.useCallback)(async () => {
  ...
  const finalizeUpload = (0, import_react.useCallback)(async () => {
    if (!uploadUrlRef.current || !fileRef.current) return;
    try {
      let cid = null;
  ...
  const simpleUpload = async (file, network, url, options) => {
    ...
    try {
      ...
      formData.append("name", ((_a = options == null ? void 0 : options.metadata) == null ? void 0 : _a.name) || file.name);
  ...
  const upload = (0, import_react.useCallback)(
    async (file, network, url, options) => {
      ...
      try {
        ...
        if ((options == null ? void 0 : options.chunkSize) && options.chunkSize > 0) {
        ...
        if ((_a = options == null ? void 0 : options.metadata) == null ? void 0 : _a.keyvalues) {
        ...
        const uploadUrl2 = urlReq.headers.get("Location");
        if (!uploadUrl2) {
        ...
        uploadUrlRef.current = uploadUrl2;
        continueChunkedUpload();
      } catch (err) {
        if (err instanceof Error) {
          setError(err);
...
export {
  ...
  analyticsTopUsage,
  containsCID,
  convertToDesiredGateway as convert,
  convertIPFSUrl,
