import { viemConnector as Se, createAppClient as be } from "@farcaster/auth-client";
export * from "@farcaster/auth-client";
import { jsx as C, jsxs as T, Fragment as J } from "react/jsx-runtime";
import * as I from "react";
import { createContext as Be, useState as P, useEffect as Z, useCallback as R, useContext as Ie, useRef as Jt, useMemo as Ae } from "react";
import { createPortal as Me } from "react-dom";
const Ne = typeof window < "u" && (window != null && window.location) ? {
...
function Pe({
  ...
  const [n, r] = P(), [o, i] = P(!1), [a, c] = P({}), [s, f] = P({}), l = {
    ...Wt,
    ...t
  }, { relay: E, rpcUrl: w, rpcUrls: d, version: g } = l;
  Z(() => {
    const h = Se({ rpcUrl: w, rpcUrls: d }), p = be({
      relay: E,
      ethereum: h,
      version: g
    });
  ...
  const u = R((h) => {
    ...
    i(!0), c({ fid: m, username: S, bio: B, displayName: b, pfpUrl: A, custody: M, verifications: N }), f({ message: p, signature: v });
  }, []), y = () => {
    i(!1), c({}), f({});
  };
  return /* @__PURE__ */ C(
...
function Te({
  ...
  const { config: c } = q(), { siweUri: s, domain: f } = c, l = lt(), [E, w] = P(!1), [d, g] = P(), [u, y] = P(), [h, p] = P(), [v, m] = P(!1), [S, B] = P(!1), [b, A] = P(), M = R(async () => {
    if (E && l && s && f && !d) {
      ...
      if (vt)
        ...
        g(tt), y(Zt), p(Dt), m(!0), o == null || o({ channelToken: tt, url: Zt, nonce: Dt });
      }
    }
  }, [
    E,
  ...
  const N = R(async () => {
    ...
    g(void 0), y(void 0), m(!1), B(!1), A(void 0);
  }, [g, y, m, B, A]), L = R(() => {
    k(), N();
  }, [N, k]);
  return {
...
function Re({
  ...
  const a = lt(), [c, s] = P(!1), [f, l] = P(!1), [E, w] = P(!1), [d, g] = P(), u = async () => {
    w(!1), l(!1), s(!1), g(void 0);
  }, y = R(async () => {
    if (a && t && e && n && r) {
      const {
        success: h,
      ...
      p ? (w(!0), g(v), i == null || i(v)) : (s(h), l(!0), o == null || o({ message: n, signature: r, validSignature: h }));
    }
  }, [a, t, e, n, r, o, i]);
  return Z(() => {
    u(), t && e && n && r && y();
...
function Le(t) {
  const e = lt(), { channelToken: n, timeout: r, interval: o, onSuccess: i, onError: a, onResponse: c } = {
    ...ke,
    ...t
  }, [s, f] = P(), [l, E] = P(!1), [w, d] = P(!1), [g, u] = P(!1), [y, h] = P(!1), [p, v] = P(), m = () => {
    f(void 0), E(!1), h(!1), d(!1), v(void 0);
  }, S = () => {
    E(!0);
  }, B = R(async () => {
    if (l && e && n) {
      ...
      A ? (h(!0), u(!1), v(M), a == null || a(M)) : (d(!0), u(!1), f(b), i == null || i(b));
    }
  }, [l, e, n, r, o, i, a, c]);
  return Z(() => {
    m(), n && B();
...
function Fe(t) {
  const e = lt(), {
  ...
  } = q(), { timeout: a, interval: c, onSuccess: s, onStatusResponse: f, onError: l, ...E } = {
    ..._e,
    ...t
  }, {
    connect: w,
    reconnect: d,
    reset: g,
    data: { channelToken: u, url: y, nonce: h },
    isSuccess: p,
    isError: v,
    error: m
  } = Te({ ...E, redirectUrl: i, onError: l }), {
    watch: S,
    isPolling: B,
    data: b,
    isError: A,
...
var De = "_1n3pr301", Ue = "_1n3pr305", Ve = "_1n3pr304", He = "_1n3pr300", Tt = "_1n3pr302", Oe = "_1n3pr303";
function Qt({ kind: t = "primary", children: e, className: n, ...r }) {
  return /* @__PURE__ */ C("button", { type: "button", className: xe[t] || n, ...r, children: e });
}
const xe = {
  primary: De,
  secondary: Tt,
...
function ze({
  ...
  return /* @__PURE__ */ T(Qt, { kind: "primary", onClick: e, disabled: n, children: [
    /* @__PURE__ */ C(Ze, { height: 20, fill: "white" }),
    /* @__PURE__ */ C("span", { style: { marginLeft: 9 }, children: t })
  ] });
}
function Ke(t, e) {
  Z(() => {
...
var Ye = "_1rbg3ua1", $e = "_1rbg3ua2", je = "_1rbg3ua3", Je = "_16wbil70", We = "_16wbil71";
function qe({ signOut: t }) {
  return /* @__PURE__ */ C("div", { className: Je, children: /* @__PURE__ */ T(
    "button",
    {
      type: "button",
      className: Tt,
      ...
      children: [
        /* @__PURE__ */ T(
          "svg",
          {
            ...
            className: We,
            children: [
              /* @__PURE__ */ C("title", { children: "Sign Out" }),
              /* @__PURE__ */ C(
                "path",
                {
          ...
          children: [
            /* @__PURE__ */ T(
              "button",
              {
                ...
                onClick: () => o(!r),
                children: [
                  /* @__PURE__ */ C("img", { className: $e, src: c, alt: "avatar" }),
                  /* @__PURE__ */ C("span", { className: je, children: a }),
                  !n && /* @__PURE__ */ T(
                    "svg",
                    {
                      width: "24",
                      ...
                      xmlns: "http://www.w3.org/2000/svg",
                      children: [
                        /* @__PURE__ */ C("title", { children: "Dropdown" }),
                        /* @__PURE__ */ C("g", { opacity: "0.5", children: /* @__PURE__ */ C(
                          "path",
                          {
                            fillRule: "evenodd",
                            clipRule: "evenodd",
...
var it = "right-scroll-bar-position", at = "width-before-scroll-bar", Xe = "with-scroll-bars-hidden", tn = "--removed-body-scroll-bar-size";
function en(t, e) {
...
function cn(t) {
  t === void 0 && (t = {});
  var e = an(null);
  return e.options = D({ async: !0, ssr: !1 }, t), e;
}
var Xt = function(t) {
...
function sn(t, e) {
  return t.useMedium(e), Xt;
}
var te = cn(), wt = function() {
}, ut = I.forwardRef(function(t, e) {
  var n = I.useRef(null), r = I.useState({
    onScrollCapture: wt,
    onWheelCapture: wt,
    onTouchMoveCapture: wt
  }), o = r[0], i = r[1], a = t.forwardProps, c = t.children, s = t.className, f = t.removeScrollBar, l = t.enabled, E = t.shards, w = t.sideCar, d = t.noIsolation, g = t.inert, u = t.allowPinchZoom, y = t.as, h = y === void 0 ? "div" : y, p = t.gapMode, v = Gt(t, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), m = w, S = rn([n, e]), B = D(D({}, v), o);
  return I.createElement(
    I.Fragment,
    null,
    l && I.createElement(m, { sideCar: te, removeScrollBar: f, shards: E, noIsolation: d, inert: g, setCallbacks: i, allowPinchZoom: !!u, lockRef: n, gapMode: p }),
...
var O = Bt ? { passive: !1 } : !1, En = function(t) {
  ...
  return ne(t, "overflowY");
}, bn = function(t) {
  return ne(t, "overflowX");
}, Vt = function(t, e) {
  ...
  var i = An(t, window.getComputedStyle(e).direction), a = i * r, c = n.target, s = e.contains(c), f = !1, l = a > 0, E = 0, w = 0;
  do {
    var d = oe(t, c), g = d[0], u = d[1], y = d[2], h = u - y - i * g;
    (g || h) && re(t, c) && (E += h, w += g), c instanceof ShadowRoot ? c = c.host : c = c.parentNode;
  } while (
    // portaled content
    !s && c !== document.body || // self content
    s && (e.contains(c) || e === c)
  );
  return (l && Math.abs(E) < 1 || !l && Math.abs(w) < 1) && (f = !0), f;
}, nt = function(t) {
...
function Rn(t) {
  var e = I.useRef([]), n = I.useRef([0, 0]), r = I.useRef(), o = I.useState(Tn++)[0], i = I.useState(ee)[0], a = I.useRef(t);
  I.useEffect(function() {
    a.current = t;
  }, [t]), I.useEffect(function() {
    if (t.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var u = Ge([t.lockRef.current], (t.shards || []).map(Ot), !0).filter(Boolean);
      return u.forEach(function(y) {
        return y.classList.add("allow-interactivity-".concat(o));
      }), function() {
        document.body.classList.remove("block-interactivity-".concat(o)), u.forEach(function(y) {
          return y.classList.remove("allow-interactivity-".concat(o));
        });
      };
    }
  }, [t.inert, t.lockRef.current, t.shards]);
  var c = I.useCallback(function(u, y) {
    ...
    if (!A)
      return !0;
    if (A ? S = b : (S = b === "v" ? "h" : "v", A = Vt(b, B)), !A)
      return !1;
    if (!r.current && "changedTouches" in u && (v || m) && (r.current = S), !S)
      return !0;
    var M = r.current || S;
    return Mn(M, y, u, M === "h" ? v : m);
  }, []), s = I.useCallback(function(u) {
    var y = u;
    if (!(!x.length || x[x.length - 1] !== i)) {
      var h = "deltaY" in y ? Ht(y) : nt(y), p = e.current.filter(function(S) {
        return S.name === y.type && (S.target === y.target || y.target === S.shadowParent) && Nn(S.delta, h);
      })[0];
      if (p && p.should) {
      ...
      if (!p) {
        var v = (a.current.shards || []).map(Ot).filter(Boolean).filter(function(S) {
          return S.contains(y.target);
        }), m = v.length > 0 ? c(y, v[0]) : !a.current.noIsolation;
        m && y.cancelable && y.preventDefault();
      }
    }
  }, []), f = I.useCallback(function(u, y, h, p) {
    var v = { name: u, delta: y, target: h, should: p, shadowParent: kn(h) };
  ...
  }, []), E = I.useCallback(function(u) {
    f(u.type, Ht(u), u.target, c(u, t.lockRef.current));
  }, []), w = I.useCallback(function(u) {
    f(u.type, nt(u), u.target, c(u, t.lockRef.current));
  }, []);
  I.useEffect(function() {
    return x.push(i), t.setCallbacks({
      onScrollCapture: E,
      onWheelCapture: E,
      onTouchMoveCapture: w
    }), document.addEventListener("wheel", s, O), document.addEventListener("touchmove", s, O), document.addEventListener("touchstart", l, O), function() {
      x = x.filter(function(u) {
        return u !== i;
      }), document.removeEventListener("wheel", s, O), document.removeEventListener("touchmove", s, O), document.removeEventListener("touchstart", l, O);
    };
  }, []);
...
const Ln = sn(te, Rn);
var ie = I.forwardRef(function(t, e) {
  return I.createElement(ut, D({}, t, { ref: e, sideCar: Ln }));
});
ie.classNames = ut.classNames;
var _n = "nao3n43", Fn = "nao3n42";
const xt = (t, e) => {
...
function Zn(t) {
  ...
  return Z(() => {
    ...
    /* @__PURE__ */ C(
      "div",
      {
        onFocus: R(() => e.current && xt(e.current, "end"), []),
        tabIndex: 0
      }
    ),
    /* @__PURE__ */ C("div", { ref: e, style: { outline: "none" }, tabIndex: -1, ...t }),
    /* @__PURE__ */ C(
      "div",
      {
        onFocus: R(() => e.current && xt(e.current, "start"), []),
        tabIndex: 0
      }
    )
  ] });
...
const On = (t) => t.stopPropagation();
function xn({ children: t, onClose: e, open: n, titleId: r }) {
  Z(() => {
  ...
  const a = R(() => e(), [e]);
  return /* @__PURE__ */ C(J, { children: n ? Me(
    /* @__PURE__ */ C(ie, { enabled: o, children: /* @__PURE__ */ C(
      "div",
      {
        style: {
...
var zn = "_1sj0tk80", zt = "_1sj0tk82", Kn = "_1sj0tk85", Kt = "_1sj0tk81", Q = {}, Yn = function() {
...
var le = {};
const Wn = F.getSymbolSize, Yt = 7;
le.getPositions = function(e) {
  const n = Wn(e);
  return [
    // top-left
    [0, 0],
...
(function(t) {
  ...
  t.isValid = function(o) {
    ...
    for (let E = 0; E < i; E++) {
      ...
      for (let w = 0; w < i; w++) {
        let d = o.get(E, w);
        d === f ? c++ : (c >= 5 && (a += e.N1 + (c - 5)), f = d, c = 1), d = o.get(w, E), d === l ? s++ : (s >= 5 && (a += e.N1 + (s - 5)), l = d, s = 1);
      }
...
var fe = {}, ht = {};
const j = new Uint8Array(512), ct = new Uint8Array(256);
(function() {
  let e = 1;
  for (let n = 0; n < 255; n++)
...
kt.prototype.initialize = function(e) {
  this.degree = e, this.genPoly = de.generateECPolynomial(this.degree);
};
kt.prototype.encode = function(e) {
  ...
  n.set(e);
  const r = de.mod(n, this.genPoly), o = this.degree - r.length;
  if (o > 0) {
...
U.BYTE = new RegExp(Gn, "g");
U.NUMERIC = new RegExp(ge, "g");
U.ALPHANUMERIC = new RegExp(Qn, "g");
const Xn = new RegExp("^" + W + "$"), tr = new RegExp("^" + ge + "$"), er = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(t) {
  ...
  t.from = function(d, g) {
    ...
    typeof u > "u" && (u = o.BYTE);
    const y = e.getSymbolTotalCodewords(d), h = n.getTotalCodewordsCount(d, g), p = (y - h) * 8;
    if (u === o.MIXED) return p;
    const v = p - f(u, d);
    switch (u) {
      case o.NUMERIC:
...
var me = {};
const At = F, ve = 1335, nr = 21522, $t = At.getBCHDigit(ve);
me.getEncodedBits = function(e, n) {
  const r = e.bit << 3 | n;
  let o = r << 10;
  for (; At.getBCHDigit(o) - $t >= 0; )
    o ^= ve << At.getBCHDigit(o) - $t;
  return (r << 10 | o) ^ nr;
};
var we = {};
const rr = H;
function z(t) {
  this.mode = rr.NUMERIC, this.data = t.toString();
}
...
function K(t) {
  this.mode = ir.ALPHANUMERIC, this.data = t;
}
...
const sr = cr, lr = H;
function Y(t) {
  this.mode = lr.BYTE, typeof t == "string" && (t = sr(t)), this.data = new Uint8Array(t);
}
...
const fr = H, dr = F;
function $(t) {
  this.mode = fr.KANJI, this.data = t;
}
...
(function(t) {
  var e = {
    single_source_shortest_paths: function(n, r, o) {
      ...
      c.push(r, 0);
      for (var s, f, l, E, w, d, g, u, y; !c.empty(); ) {
        s = c.pop(), f = s.value, E = s.cost, w = n[f] || {};
        for (l in w)
          w.hasOwnProperty(l) && (d = w[l], g = E + d, u = a[l], y = typeof a[l] > "u", (y || u > g) && (a[l] = g, c.push(l, g), i[l] = f));
      }
...
var gr = pe.exports;
(function(t) {
  const e = H, n = or, r = ar, o = ur, i = hr, a = U, c = F, s = gr;
  function f(h) {
 ...
 Suggested mode is: ` + e.toString(m));
  ...
  t.fromArray = function(p) {
    return p.reduce(function(v, m) {
      return typeof m == "string" ? v.push(y(m, null)) : m.data && v.push(y(m.data, m.mode)), v;
    }, []);
  }, t.fromString = function(p, v) {
    const m = E(p, c.isKanjiModeEnabled()), S = g(m), B = u(S, v), b = s.find_path(B.map, "start", "end"), A = [];
    for (let M = 1; M < b.length - 1; M++)
      A.push(B.table[b[M]].node);
    return t.fromArray(d(A));
  }, t.rawSplit = function(p) {
    return t.fromArray(
      E(p, c.isKanjiModeEnabled())
    );
  };
})(we);
const gt = F, Ct = ft, mr = jn, vr = Jn, wr = se, pr = le, Mt = ue, Nt = dt, yr = qn, st = he, Cr = me, Er = H, Et = we;
function Sr(t, e) {
  const n = t.size, r = pr.getPositions(e);
  for (let o = 0; o < r.length; o++) {
    const i = r[o][0], a = r[o][1];
    for (let c = -1; c <= 7; c++)
      if (!(i + c <= -1 || n <= i + c))
        for (let s = -1; s <= 7; s++)
          a + s <= -1 || n <= a + s || (c >= 0 && c <= 6 && (s === 0 || s === 6) || s >= 0 && s <= 6 && (c === 0 || c === 6) || c >= 2 && c <= 4 && s >= 2 && s <= 4 ? t.set(i + c, a + s, !0, !0) : t.set(i + c, a + s, !1, !0));
  }
}
function br(t) {
  const e = t.size;
...
function Br(t, e) {
  const n = wr.getPositions(e);
  for (let r = 0; r < n.length; r++) {
    const o = n[r][0], i = n[r][1];
    for (let a = -2; a <= 2; a++)
      for (let c = -2; c <= 2; c++)
        a === -2 || a === 2 || c === -2 || c === 2 || a === 0 && c === 0 ? t.set(o + a, i + c, !0, !0) : t.set(o + a, i + c, !1, !0);
  }
}
function Ir(t, e) {
  ...
  let o, i, a;
  for (let c = 0; c < 18; c++)
    o = Math.floor(c / 3), i = c % 3 + n - 8 - 3, a = (r >> c & 1) === 1, t.set(o, i, a, !0), t.set(i, o, a, !0);
}
function St(t, e, n) {
  const r = t.size, o = Cr.getEncodedBits(e, n);
  let i, a;
  for (i = 0; i < 15; i++)
    a = (o >> i & 1) === 1, i < 6 ? t.set(i, 8, a, !0) : i < 8 ? t.set(i + 1, 8, a, !0) : t.set(r - 15 + i, 8, a, !0), i < 8 ? t.set(8, r - i - 1, a, !0) : i < 9 ? t.set(8, 15 - i - 1 + 1, a, !0) : t.set(8, 15 - i - 1, a, !0);
  t.set(r - 8, 8, 1, !0);
}
function Ar(t, e) {
  const n = t.size;
...
function Mr(t, e, n) {
  ...
  n.forEach(function(s) {
    r.put(s.mode.bit, 4), r.put(s.getLength(), Er.getCharCountIndicator(s.mode, t)), s.write(r);
  });
...
function Nr(t, e, n) {
  const r = gt.getSymbolTotalCodewords(e), o = Nt.getTotalCodewordsCount(e, n), i = r - o, a = Nt.getBlocksCount(e, n), c = r % a, s = a - c, f = Math.floor(r / a), l = Math.floor(i / a), E = l + 1, w = f - l, d = new yr(w);
  let g = 0;
  const u = new Array(a), y = new Array(a);
  let h = 0;
  const p = new Uint8Array(t.buffer);
  for (let b = 0; b < a; b++) {
    const A = b < s ? l : E;
    u[b] = p.slice(g, g + A), y[b] = d.encode(u[b]), g += A, h = Math.max(h, A);
  }
...
`
  ...
  const a = Mr(e, n, o), c = gt.getSymbolSize(e), s = new vr(c);
  return Sr(s, e), br(s), Br(s, e), St(s, n, 0), e >= 7 && Ir(s, e), Ar(s, a), isNaN(r) && (r = Mt.getBestMask(
    s,
    St.bind(null, s, n)
...
ae.create = function(e, n) {
  ...
  let r = Ct.M, o, i;
  return typeof n < "u" && (r = Ct.from(n.errorCorrectionLevel, Ct.M), o = st.from(n.version), i = Mt.from(n.maskPattern), n.toSJISFunc && gt.setToSJISFunction(n.toSJISFunc)), Pr(e, o, r, i);
};
var ye = {}, _t = {};
(function(t) {
  function e(n) {
  ...
  t.getOptions = function(r) {
    ...
    const a = o.modules.size, c = o.modules.data, s = t.getScale(a, i), f = Math.floor((a + i.margin * 2) * s), l = i.margin * s, E = [i.color.light, i.color.dark];
    for (let w = 0; w < f; w++)
      for (let d = 0; d < f; d++) {
        let g = (w * f + d) * 4, u = i.color.light;
        if (w >= l && d >= l && w < f - l && d < f - l) {
          const y = Math.floor((w - l) / s), h = Math.floor((d - l) / s);
          u = E[c[y * a + h] ? 1 : 0];
        }
...
(function(t) {
  ...
  t.render = function(i, a, c) {
    ...
    const l = e.getImageWidth(i.modules.size, s), E = f.getContext("2d"), w = E.createImageData(l, l);
    return e.qrToImageData(w.data, i, s), n(E, f, l), E.putImageData(w, 0, 0), f;
  }, t.renderToDataURL = function(i, a, c) {
    let s = c;
    typeof s > "u" && (!a || !a.getContext) && (s = a, a = void 0), s || (s = {});
    const f = t.render(i, a, s), l = s.type || "image/png", E = s.rendererOpts || {};
    return f.toDataURL(l, E.quality);
  };
})(ye);
var Ce = {};
const Tr = _t;
...
function Rr(t, e, n) {
  ...
  for (let c = 0; c < t.length; c++) {
    ...
    !s && !i && (i = !0), t[c] ? (a++, c > 0 && s > 0 && t[c - 1] || (r += i ? bt("M", s + n, 0.5 + f + n) : bt("m", o, 0), o = 0, i = !1), s + 1 < e && t[c + 1] || (r += bt("h", a), a = 0)) : o++;
  }
  return r;
}
Ce.render = function(e, n, r) {
  const o = Tr.getOptions(n), i = e.modules.size, a = e.modules.data, c = i + o.margin * 2, s = o.color.light.a ? "<path " + jt(o.color.light, "fill") + ' d="M0 0h' + c + "v" + c + 'H0z"/>' : "", f = "<path " + jt(o.color.dark, "stroke") + ' d="' + Rr(a, i, o.margin) + '"/>', l = 'viewBox="0 0 ' + c + " " + c + '"', w = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + l + ' shape-rendering="crispEdges">' + s + f + `</svg>
`;
  return typeof r == "function" && r(null, w), w;
};
const kr = Yn, Pt = ae, Ee = ye, Lr = Ce;
...
Q.create = Pt.create;
Q.toCanvas = Ft.bind(null, Ee.render);
Q.toDataURL = Ft.bind(null, Ee.renderToDataURL);
Q.toString = Ft.bind(null, function(t, e, n) {
  return Lr.render(t, n);
});
const _r = (t, e) => {
...
function Fr({ ecl: t = "M", size: e = 200, uri: n }) {
  const o = e - parseInt("20", 10) * 2, i = Ae(() => {
    const a = [], c = _r(n, t), s = o / c.length;
    return [
      { x: 0, y: 0 },
      { x: 1, y: 0 },
      { x: 0, y: 1 }
    ].forEach(({ x: l, y: E }) => {
      const w = (c.length - 7) * s * l, d = (c.length - 7) * s * E;
      for (let g = 0; g < 3; g++)
        a.push(
          /* @__PURE__ */ C(
            "rect",
      ...
      l.forEach((w, d) => {
        c[E][d] && (E < 7 && d < 7 || E > c.length - 8 && d < 7 || E < 7 && d > c.length - 8 || a.push(
          /* @__PURE__ */ C(
            "rect",
            {
              fill: "black",
  ...
  return /* @__PURE__ */ T("div", { className: Ve, children: [
    /* @__PURE__ */ C(
      "div",
      {
        className: Ue,
    ...
    /* @__PURE__ */ T("svg", { height: o, style: { all: "revert" }, width: o, children: [
      /* @__PURE__ */ C("title", { children: "QR Code" }),
      /* @__PURE__ */ C("rect", { fill: "transparent", height: o, width: o }),
      i
    ] })
  ] });
}
function Zr({
  ...
  return /* @__PURE__ */ C(xn, { open: t, titleId: "Sign in with Farcaster", onClose: e, children: /* @__PURE__ */ C("div", { className: "fc-authkit-qrcode-dialog", children: /* @__PURE__ */ C("div", { className: zn, children: r ? /* @__PURE__ */ T(J, { children: [
    /* @__PURE__ */ C("div", { className: Kt, children: "Error" }),
    /* @__PURE__ */ C("div", { className: zt, children: (o == null ? void 0 : o.message) ?? "Unknown error, please try again." })
  ] }) : /* @__PURE__ */ T(J, { children: [
    /* @__PURE__ */ C("div", { className: Kt, children: "Sign in with Farcaster" }),
    /* @__PURE__ */ C("div", { className: zt, children: "To sign in with Farcaster, scan the code below with your phone's camera." }),
    /* @__PURE__ */ C("div", { className: Kn, children: /* @__PURE__ */ C(Fr, { uri: n, size: 200 }) }),
    /* @__PURE__ */ C("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ T(
      Qt,
      {
        kind: "tertiary",
        style: {
        ...
        children: [
          /* @__PURE__ */ T(
            "svg",
            {
              ...
              fill: "none",
              children: [
                /* @__PURE__ */ C("title", { children: "Sign in With Farcaster QR Code" }),
                /* @__PURE__ */ C(
                  "path",
                  {
                    fill: "#7C65C1",
          ...
          /* @__PURE__ */ C("span", { style: { marginLeft: 9 }, children: "I'm using my phone →" })
        ]
      }
    ) })
  ] }) }) }) });
...
function Ur({
  ...
  const { onSuccess: o, onStatusResponse: i, onError: a } = r, c = R(
    (L) => {
      o == null || o(L);
    },
    [o]
    ...
    h && u(), M(!0), w(), m && It() && window.open(m, "_blank");
  }, [h, u, w, m]), k = y && B;
  return Z(() => {
    v || g();
  }, [v, g]), /* @__PURE__ */ T("div", { className: "fc-authkit-signin-button", children: [
    k ? /* @__PURE__ */ C(
      Qe,
      {
        userData: S,
      ...
      /* @__PURE__ */ C(ze, { initializing: !m, onClick: N, label: "Sign in" }),
      m && /* @__PURE__ */ C(
        Zr,
        {
          open: A && !It(),
    ...
    t && /* @__PURE__ */ C("div", { className: Dr, children: /* @__PURE__ */ C("pre", { children: JSON.stringify(E, null, 2) }) })
  ] });
}
function Vr() {
...
function Yr() {
  return /* @__PURE__ */ T(Pe, { config: {
    rpcUrl: "https://mainnet.optimism.io"
  }, children: [
    /* @__PURE__ */ C("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 1e3 }, children: /* @__PURE__ */ C(
      Ur,
      {
        nonce: "abcd1234",
...
function Hr() {
  ...
  return /* @__PURE__ */ C("div", { style: { fontFamily: "sans-serif" }, children: t && /* @__PURE__ */ T("div", { children: [
    e && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ C("strong", { children: "FID:" }),
      " ",
      e
    ] }),
    r && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ C("strong", { children: "Display name:" }),
      " ",
      r
    ] }),
    n && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ C("strong", { children: "Bio:" }),
      " ",
      n
    ] }),
    o && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ C("strong", { children: "Custody address:" }),
      " ",
      o
    ] })
  ] }) });
